...
## TODO:
- ~~Replace Etherscan's `txlistinternal` call with Alchemy before July 1st, 2026** - https://www.alchemy.com/docs/what-are-internal-transactions~~
- **Figure out what to do about Etherscan putting `txlistinternal` behind a paywall**
